...
public class LevelPlayChooseEight extends AppCompatActivity {
    ImageView l1;
    ImageView l2;
    ImageView l3;
    ImageView l4;
    ...
    public void showLevelButton() {
        ...
        dataBaseHandlerLevels db = new dataBaseHandlerLevels(LevelPlayChooseEight.this);
        int n;
        try {
            n = db.showLevelNoEight();
        } catch(Exception e) {
    ...
    protected void onResume() {
        super.onResume();
        DataBaseHandlerMT db = new DataBaseHandlerMT(LevelPlayChooseEight.this);
        if (db.showMusic() == 1) {
            PerfectLoopMediaPlayer.release();
            PerfectLoopMediaPlayer.create(LevelPlayChooseEight.this, R.raw.bg);
        } else if (db.showMusic() == 2) {
            PerfectLoopMediaPlayer.release();
            PerfectLoopMediaPlayer.create(LevelPlayChooseEight.this, R.raw.bg2);
        } else if (db.showMusic() == 3) {
            PerfectLoopMediaPlayer.release();
            PerfectLoopMediaPlayer.create(LevelPlayChooseEight.this, R.raw.bg3);
        } else {
            PerfectLoopMediaPlayer.release();
            PerfectLoopMediaPlayer.create(LevelPlayChooseEight.this, R.raw.bg4);
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("whetherEight", "LevelEight"+whetherEight);
        showLevelButton();
    }
}