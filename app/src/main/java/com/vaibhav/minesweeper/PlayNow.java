...
public class PlayNow extends AppCompatActivity{
    ...
    int[][] unique = new int[20][2];//Change for new number of bombs
    int[] a = new int[20];//Change for new number of bombs
    int[] b = new int[20];//Change for new number of bombs
    ...
    public void cell(View view) {
        ...
        if(lost == 0) {
            TextView status = findViewById(R.id.status);
            if (opened == 80) {//Change for new number of bombs
                if (timeOver != 0) {
                    timeOver--;
                ...
                status1.setText("Bombs: 20");//Change for new number of bombs
            }
        }
    }
    private void showBomb() {
        for(int i = 0; i < 20; i++) {//Change for new number of bombs
    ...
    private void setSurroundings() {
        for(int i = 0; i < 20; i++) { //updating mine in surroundings
