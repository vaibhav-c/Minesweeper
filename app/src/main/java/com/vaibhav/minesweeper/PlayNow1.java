...
public class PlayNow1 extends AppCompatActivity{
    int c = 0, timeOver = 0, tt = 0, lost = 0, resEt = 0, bombNo = 15, timerValue = 90000, unlockLevel = 0;
        ...
        if(lost == 0) {
            ...
            if (opened == (81 - bombNo)) {//Change for new number of bombs
                if (timeOver != 0) {
                    ...
                    if(whetherEight == 0) {
                        dataBaseHandlerLevels db = new dataBaseHandlerLevels(PlayNow1.this);
    ...
    public void onBackPressed() {
        ...
        PerfectLoopMediaPlayer.create(PlayNow1.this, R.raw.bg);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bombNo = intent.getIntExtra("bombNo", 15);
        ...
        DataBaseHandlerMT dataBaseHandlerMT = new DataBaseHandlerMT(PlayNow1.this);
        int n;
        try {
