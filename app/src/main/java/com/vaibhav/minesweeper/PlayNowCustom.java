...
public class PlayNowCustom extends AppCompatActivity{
    int c = 0, timeOver = 0, tt = 0, lost = 0, resEt = 0, bombNo = 90, timerValue = 120000;
            ...
            if(resEt == 0) {
                ...
                t = new CountDownTimer(timerValue, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        timeOver++;
                        ringer.stop();
                        timerGone = MediaPlayer.create(PlayNowCustom.this, R.raw.timergone);
                        timerGone.start();
                        tt++;
                    }
                }.start();
        ...
        if(lost == 0) {
            ...
            if (opened == (100 - bombNo)) {//Change for new number of bombs
                if (timeOver != 0) {
                    ...
                    status.setText("Win. Score " + tim * 600000 / timerValue * bombNo / 50 * 4);
                    TextView status1 = findViewById(R.id.statusBomb);
                    status1.setText("Bombs: " + bombNo);
                    if(whetherEight == 0) {
                        dataBaseHandler db = new dataBaseHandler(PlayNowCustom.this);
                        Date d = new Date(System.currentTimeMillis());
                        highScore hs = new highScore(tim * 600000 / timerValue * bombNo / 50 * 4, fmt.format(d));
                ...
                fireworks = MediaPlayer.create(PlayNowCustom.this, R.raw.fireworks);
                ringer.stop();
                fireworks.start();
        ...
        for(int i = 0; i < bombNo; i++) {//Change for new number of bombs
            ...
            if(opened == (100 - bombNo)) {//Change for new number of bombs
                ...
                new CountDownTimer(1000, 1000) { // 5000 = 5 sec
                    ...
                    public void onFinish() {
                        if(finalI == 0) {
                            ring = MediaPlayer.create(PlayNowCustom.this, R.raw.ring);
                            ring.start();
                        }
    ...
    public void reset(View view) {
        ...
        ringer = MediaPlayer.create(PlayNowCustom.this,R.raw.ringer);
        ringer.start();
        ringer.setLooping(true);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DataBaseHandlerMT dataBaseHandlerMT = new DataBaseHandlerMT(PlayNowCustom.this);
        int n;
        try {
    ...
    public void onBackPressed() {
        ...
        PerfectLoopMediaPlayer.create(PlayNowCustom.this, R.raw.bg);
    }
    @Override
